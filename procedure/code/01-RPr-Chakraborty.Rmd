...
The **spatial extent** of the study are the 48 contiguous states in the U.S.
...
Generate dot-and-whisker plot of coefficients for each of the model variations.
...
Interestingly, the most variance in model results seems to appear with the most insignificant change: switching the computational environment from SPSS to geepack in R.
