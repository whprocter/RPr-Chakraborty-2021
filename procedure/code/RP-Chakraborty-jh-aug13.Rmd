...
st_write(covid, here("data","derived","public","covid_clusters.gpkg"))
...
pov_gee <- gee(covid_rate_z ~ bpov_z + apov_z, # regression formula, dependent var first, then sequence of independent variables
